...
//             const maticApprove = await matic.approve(
//                 wmatic.getAddress(),
//                 ninetyFivePercentMatic,
//                 { gasLimit: gasLimit }
//             )
...
//         }
//         if (wmaticBal.gt(0)) {
//             const ninetyFivePercentMatic = await wmatic.balanceOf(
//                 signer.getAddress()
//             )
//             return ninetyFivePercentMatic
//         } else {
...
//         console.log(
//             'Balance of MATIC:: ',
//             fu(await matic.balanceOf(signer.getAddress()), 18)
//         )
//         console.log(
//             'Balance of WMATIC: ',
//             fu(await wmatic.balanceOf(signer.getAddress()), 18)
//         )
//         console.log(
//             'Balance of USDC::: ',
//             fu(await usdc.balanceOf(signer.getAddress()), 6)
//         )
//         const quickPool = new ethers.Contract(
...
//         const approveWmatic = await wmatic
//             .connect(signer)
//             .approve(quickRouter.getAddress(), ninetyFivePercentMatic)
//         if (approveWmatic) console.log('WMATIC on QUICKROUTER APPROVED')

//         const preTradeReserves = await quickPool.getReserves()
//         console.log(
//             'Reserves: ',
//             preTradeReserves[0].toString(),
//             preTradeReserves[1].toString()
//         )
//         const amountOut = await quickRouter
//             .connect(signer)
//             .getAmountsOut(ninetyFivePercentMatic, [
//                 wmatic.getAddress(),
//                 usdc.getAddress(),
//             ])
...
//         console.log(
//             'New Balance of MATIC:: ',
//             fu(await wmatic.balanceOf(signer.getAddress()), 18)
//         )
//         console.log(
//             'New Balance of WMATIC: ',
//             fu(await wmatic.balanceOf(signer.getAddress()), 18)
//         )
//         console.log(
//             'New Balance of USDC: ',
...
//         )
//         console.log(
//             'New QuickPool Reserves: ',
//             postTradeReserves0.toString(),
//             postTradeReserves1.toString()
//         )
//     }
// }
