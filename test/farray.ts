    ...
    let fata = [
        {
            ...
            direction: {
                ...
                verbose:
                    "Flash V2b token0 to V2a token1, sell V2a token1 for V2b token0 to repay the loan and keep the profit",
        ...
        },
        {
            ...
            direction: {
                ...
                verbose:
                    "Flash V2a token0 to V2b token1, sell v2b token1 for V2a token0 to repay the loan and keep the profit",
...
async function main() {
    ...
    farray.forEach((pair) => {
        let token0 = pair.pair.token1;
        let token1 = pair.pair.token0;
        console.log("Testtoken0token1: " + token0, token1);
        if (pair.direction.direction == "Quick Token0 -> Sushi Token1") {
            //I may need to use either use an array method or a switch statement to make this more efficient
