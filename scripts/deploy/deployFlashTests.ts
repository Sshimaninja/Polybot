...
async function main() {
    try {
        ...
        const FlashMultiTestFactory = new ethers.ContractFactory(flashMultiTestAbi, flashMultiTestBytecode, signer);
        ...
        const flashMultiContract = new ethers.Contract(flashMultiTestAddress, flashMultiTestAbi, provider);
